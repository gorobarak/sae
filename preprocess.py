...
def preprocess(dataset_name: str, model_name: str, L_max: int = 256):
    ...
    # remove all columns except input_ids and length
    filtered_dataset = filtered_dataset.remove_columns([col for col in filtered_dataset.column_names if col not in ["input_ids", "length"]])
...
if __name__ == "__main__":
    ...
    for model_name in ["microsoft/Phi-3-mini-4k-instruct", "mistralai/Mistral-7B-Instruct-v0.1"]:
